  ...
  module Commands
    class Github
      ...
      def call
        ...
        release = ensure_release_for_tag(tag, body, title, tag_sha)
      ...
      def ensure_release_for_tag(tag, body, title, tag_sha)
        release = github.release(tag)
        return github.create_release(tag, body, title:, draft: true) unless release
